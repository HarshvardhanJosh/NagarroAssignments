...
const apiKey = "b4b4071b-eca1-46db-b4bd-69ca7086540c";
const url = `https://api.cricapi.com/v1/currentMatches?apikey=${apiKey}&offset=0`;
let count=0;
window.addEventListener("load", getFactFetch);
function getFactFetch(){
  root.innerHTML = `<div class="spinner-border text-dark align-self-center" role="status"><span class="visually-hidden">Loading...</span></div>`;
  fetch(url)
    .then((res) => res.json())
    .then((data) => {
